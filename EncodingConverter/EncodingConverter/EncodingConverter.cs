...
using EncodingConverter.Helper;
using EncodingConverter.ViewModel;
using EnvDTE;
using EnvDTE80;
...
namespace EncodingConverter
{
    ...
    internal sealed class EncodingConverter
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("3ee6aba6-f85d-4929-954c-13d7d3bc3093");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EncodingConverter"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private EncodingConverter(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in EncodingConverter's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new EncodingConverter(package, commandService);
        }
